package net.pmkjun.pyrofishinghelper.gui.widget;
...
public class Slider extends SliderWidget {
    ...
    public Slider(int x, int y, int width, int height, Text text, double minValue, double maxValue, double currentValue) {
